...
/**
 * Base for headless integration tests: full application context, real Postgres
 * and Kafka, no web layer.
 *
 * <p>Test settings live in {@code application-test.yml} as a profile overlay
 * rather than in a second {@code application.yml}, which would shadow the real
 * one on the classpath and silently drop everything it configures.
 */
