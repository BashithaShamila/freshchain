...
import com.freshchain.inventory.api.dto.ApiError;
import com.freshchain.inventory.domain.InsufficientStockException;
...
public class GlobalExceptionHandler {
     ...
     * moment ago; the stock moved underneath it.
     */
    @ExceptionHandler(InsufficientStockException.class)
    public ResponseEntity<ApiError> insufficientStock(InsufficientStockException e, HttpServletRequest request) {
